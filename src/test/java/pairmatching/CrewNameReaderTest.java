...
class CrewNameReaderTest {
    ...
    @Test
    void test1() {
        List<String> backendCrewNames = nameReader.readCrewNames(CourseCommand.BACKEND.getPath());
    ...
    @Test
    void test3() {
        List<String> frontendCrewNames = nameReader.readCrewNames(CourseCommand.FRONTEND.getPath());
