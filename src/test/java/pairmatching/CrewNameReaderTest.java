...
class CrewNameReaderTest {
    ...
    void test1() throws IOException {
        List<String> backendCrewNames = nameReader.readCrewNames(CourseCommand.BACKEND);
    ...
    void test3() throws IOException {
        List<String> frontendCrewNames = nameReader.readCrewNames(CourseCommand.FRONTEND);
